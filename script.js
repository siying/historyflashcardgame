...
let ALL_EVENTS = WORLD_EVENTS_EN;

function setMode(mode) {
  currentMode = mode;
  t = STRINGS[mode];
  if (mode === "world-en") ALL_EVENTS = WORLD_EVENTS_EN;
  else if (mode === "world-zh") ALL_EVENTS = WORLD_EVENTS_ZH;
  else if (mode === "china-zh") ALL_EVENTS = CHINA_EVENTS_ZH;
  applyTranslations();
